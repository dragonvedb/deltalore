...
- **61 *(20% chance)* - Gaster Follower #2** looks similar to the Scared Donut Guy, except instead of donut, they hold what looks like a small head, which they claim to be a piece of <a onclick="loadFile('Doctor W. D. Gaster.md')">W. D. Gaster</a>. Strangely, the head appears to actually be the one speaking.
This follower is somewhat different from the other two. They appear more rarely, speak in rhymes and immediately disappear after finishing their speech with the *snd_mysterygo* sound (just like <a onclick="loadFile('Mystery Man.md')"></a> and <a onclick="loadFile('Clam Girl.md')">Goner Clam Girl</a>). The significance of these differences is unknown.

Dialogue:
- _<a onclick="loadFile('Asgore.md')">Alphys</a> might work faster. But the old Royal Scientist, Doctor W.D. Gaster?_
...
- **63 *(50% chance)* - Gaster Follower #3** has no analogue in UNDERTALE, but looks similar to the Striped Bird from DELTARUNE.
  Dialogue:
	...
	- _Why does Striped Bird blocking <a onclick="loadFile('Kris.md')">Kris</a> from parts of the library In both Ch1 and Ch2?_ 
		- *And why is Striped Bird's name in the game files 'spr_normalnpc'?*
